        ...
        return <Col className="scroll fill" style={ styles.container }>
            <Form.Field><LabeledSelect id="shotInterval" label="Shot interval" options={shotIntervalOptions} value={this.state.settings.shotInterval} onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.shotInterval = value; } )); } } /></Form.Field>
            {
                this.state.settings.shotInterval=="short" ? <>
                    <Form.Field><LabeledTextInput label="Quality"                                             value={this.state.settings.normal.quality        } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.quality         = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="Sharpness"                                           value={this.state.settings.normal.sharpness      } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.sharpness       = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="Contrast"                                            value={this.state.settings.normal.contrast       } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.contrast        = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="Brightness"                                          value={this.state.settings.normal.brightness     } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.brightness      = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="Saturation"                                          value={this.state.settings.normal.saturation     } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.saturation      = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="Shutter speed"                                       value={this.state.settings.normal.shutterSpeed   } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.shutterSpeed    = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="ISO"                                                 value={this.state.settings.normal.iso            } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.iso             = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledSelect    label="DRC (experimental)"    options={drcOptions}          value={this.state.settings.normal.drc            } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.drc             = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledSelect    label="White balance"         options={whiteBalanceOptions} value={this.state.settings.normal.whiteBalance   } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.whiteBalance    = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledTextInput label="Projection delay"                                    value={this.state.settings.normal.projectionDelay} onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.projectionDelay = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledSelect    label="Strip light intensity" options={stripLightOptions}   value={this.state.settings.normal.stripLight     } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.stripLight      = value; } )); } } /></Form.Field>
                    <Form.Field><LabeledSelect    label="Rotation"              options={rotationOptions}     value={this.state.settings.normal.rotation       } onChange={ ({target:{value}}) => { this.changeState(produce( state => { state.settings.normal.rotation        = value; } )); } } /></Form.Field>
                    </> :
