            ...
            <Form ref={this.getFormRef}>
                ...
                <Col style={{ display: "block" }} className="fill scroll">
                    ...
                    <Col style={ styles.container }>
                        ...
                        <Form.Field><LabeledTextInput id="h265bitrate" label="h.265 bitrate" value={this.state.settings.h265bitrate} onChange={ ({target:{value}}) => { this.setState(produce( state => { state.settings.h265bitrate = value; } )); } } /></Form.Field>
                        <Row style={{width:"100%"}}>
